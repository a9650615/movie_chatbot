...
app.use(KoaBody())
app.use(cors())
app.use(route.post('/news', ApiController.addNews))
...
app.use(route.get('/news/:movie_id', ApiController.getNews))
app.use(route.get('/favorite/:user', ApiController.getFavorite))
